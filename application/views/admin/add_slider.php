                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        <label>Teks 1</label>
                                                        <input type="text" class="form-control" name="teks1" value="<?php echo set_value('teks1'); ?>" autofocus="">
                                                        <small class="text-danger"><?php echo form_error('teks1'); ?></small>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label>Teks 2</label>
                                                        <input type="text" class="form-control" name="teks2" value="<?php echo set_value('teks2'); ?>">
                                                        <small class="text-danger"><?php echo form_error('teks2'); ?></small>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label>Teks 3</label>
                                                        <input type="text" class="form-control" name="teks3" value="<?php echo set_value('teks3'); ?>">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label>Urutan</label>
                                                        <input type="number" min="1" class="form-control" name="urutan" value="<?php echo set_value('urutan'); ?>">
