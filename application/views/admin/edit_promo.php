                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label>Nama</label>
                                                        <input type="text" class="form-control" name="judul" value="<?php echo $promoid['promo_judul']; ?>" autofocus="">
                                                        <small class="text-danger"><?php echo form_error('judul'); ?></small>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Kode</label>
                                                        <input type="text" class="form-control" name="kode" value="<?php echo $promoid['promo_kode']; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label>Diskon (%)</label>
                                                        <input type="number" min="1" max="100" class="form-control" name="persen" value="<?php echo $promoid['promo_persen']; ?>">
                                                        <small class="text-danger"><?php echo form_error('persen'); ?></small>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Masa berlaku</label>
                                                        <input type="date" min="<?php echo date('Y-m-d'); ?>" class="form-control" name="masa" value="<?php echo $promoid['promo_masa']; ?>">
