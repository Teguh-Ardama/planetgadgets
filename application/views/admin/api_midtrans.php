                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label>API mid client</label>
                                                        <input type="text" class="form-control" name="client" value="<?php echo $apiconfig['api_mid_client']; ?>" autofocus="">
                                                        <small class="text-danger"><?php echo form_error('client'); ?></small>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>API mid server</label>
                                                        <input type="text" class="form-control" name="server" value="<?php echo $apiconfig['api_mid_server']; ?>">
                                                        <small class="text-danger"><?php echo form_error('server'); ?></small>
                                                    </div>
                                                </div>
