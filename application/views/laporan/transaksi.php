<div class="gap inner-bg">
                  ...
                  <div class="table-styles">
                    ...
                    <form action="<?php echo base_url(); ?>laporan/lihat_transaksi" method="post">
                      <h4>Sortir berdasarkan tanggal</h4><br>
                      <div class="row">
                        <div class="col-md-5">
                          <label>Mulai</label>
                    ...
                    <?php if($start == '') { ?>
                      <a href="<?php echo base_url(); ?>laporan/print_trx" target="_blank" class="btn-st grn-clr mt-3"><i class="fa fa-print"></i> Print</a>
                      <a href="<?php echo base_url(); ?>laporan/pdf_trx" target="_blank" class="btn-st rd-clr"><i class="fa fa-file-pdf-o"></i> Unduh PDF</a>
                      <a href="<?php echo base_url(); ?>laporan/excel_trx" target="_blank" class="btn-st org-clr"><i class="fa fa-file-excel-o"></i> Unduh Excel</a>
                    <?php }else { ?>
                      <a href="<?php echo base_url(); ?>laporan/print_transaksi/<?php echo $start; ?>/<?php echo $end; ?>" target="_blank" class="btn-st grn-clr mt-3"><i class="fa fa-print"></i> Print</a>
                      ...
                      <a href="<?php echo base_url(); ?>laporan/excel_transaksi/<?php echo $start; ?>/<?php echo $end; ?>" target="_blank" class="btn-st org-clr"><i class="fa fa-file-excel-o"></i> Unduh Excel</a>
                    <?php } ?>
                    <div class="widget">
